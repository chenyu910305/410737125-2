...
let points = [[14,5],[13,2],[12,0],[13,-3],[10,-1],[4,-2],[3,-4],[1,-3],[-4,-3],[-6,-2],[-6,-7],[-8,-5],[-9,-2],[-13,-1],[-11,0],[-14,1],[-12,2],[-9,3],[-4,3],[-2,7],[0,3],[3,2],[9,1],[14,5]]
...
function preload(){ //程式碼準備執行之前，比set up()更早執行
  elephant_sound = loadSound("sound/monster.mp3")
...
function draw() {
  ...
  //飛彈的顯示
   ...
   {
    if(monster.dead==true && monster.timenum>400000000000){
